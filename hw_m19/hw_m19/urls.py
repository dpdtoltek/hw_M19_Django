"""
URL configuration for hw_m19 project.
...
from task1.views import platform, games, cart, sign_up_by_html, sign_up_by_django, news, faq, review
...
urlpatterns = [
    ...
    path('platform/faq/', faq, name='faq'),
    path('platform/review/', review, name='review'),
]
